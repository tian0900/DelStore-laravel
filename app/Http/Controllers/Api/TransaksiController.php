...
class TransaksiController extends Controller {
    ...
    public function dibayar($id){
        ...
        if ($transaksi){
            ...
            $this->pushNotif('Transaksi Diproses', "Transasi produk ".$transaksi->details[0]->produk->name." telah dibayar dan sedang diproses", $transaksi->user->fcm);
    ...
    public function pushNotif($title, $message, $mFcm) {
        ...
        curl_setopt_array($curl, array(
            ...
            CURLOPT_HTTPHEADER => array(
                ...
                "Authorization: key=AAAAnH9Bvwc:APA91bGguklAT42eHvisv2DYqypnjiFvHzB8sG9bcEf5rDC9NN8s87P8JHTQRWbHwOovIrmGJuCt5llXr2nzSvKolEzs9o39FGyQCX38cxpcwwwWbNnW6fG0GOuxC7E8tYO4G1BoTEzR"
            ),
        ));
